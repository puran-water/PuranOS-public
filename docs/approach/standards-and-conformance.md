...
| CFIHOS | Capital facilities handover information | Equipment item schemas include a subset of attributes relevant to capital project handover (materials of construction, capacity, dimensions). Full CFIHOS coverage (manufacturer data, design conditions, nameplate data) is a future alignment target. |
